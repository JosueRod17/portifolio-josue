...
const projects = [
  ...
  {
    title: 'Portifólio Atual',
    featured: true,
    description:
      'Desenvolvimento de um portfolio com foco em design moderno, animações fluidas e experiência visual responsiva utilizando React e TailwindCSS.',
    tech: ['React', 'TailwindCSS', 'Vite', 'JavaScript'],
    image:
      projeto8,
    github: 'https://github.com/JosueRod17/portifolio-josue',
    demo: 'https://portifolio-josue-sandy.vercel.app/',
  },
]
